...
We select the words that occur in 7410 documents (i.e., at least 1 in 100000 documents), and extract the characters therein.  Traditional characters were converted to simplified using [OpenCC](https://github.com/yichen0831/opencc-python).

The characters not included in MteH v0.1.1 are:
