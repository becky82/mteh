...
The file `CKIP_traditional.txt` is the vocab list (20769 traditional Chinese words) posted in the discussion for the Wikipedia page [Appendix:Mandarin Frequency lists](https://en.wiktionary.org/wiki/Appendix:Mandarin_Frequency_lists).  OpenCC was used to convert to simplified characters, and the simplified characters (3392 total) therein were extracted, giving `CKIP_chars_unicode_order.txt`.
