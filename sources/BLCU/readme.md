...
We then use `head -n 6000 BLCU_chars_frequency_order.txt | awk '{print $1}' | sort -u` to get the top-6000 characters from this set, giving `BLCU_6000_chars_unicode_order.txt` (6000 chars).
