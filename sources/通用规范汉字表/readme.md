《通用规范汉字表》 is an official character list by the Chinese government's Ministry of Education, published in June 2013.  There are three levels:

- 一级字表 (level 1): 3500 characters;
- 二级字表 (level 2): 3000 characters;
