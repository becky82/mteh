...
FILES=(
    ...
    "../latex/mteh_HSK5+_answers.pdf"
    "../latex/mteh_HSK5_noanswers.pdf"
    "../latex/mteh_HSK5+_noanswers.pdf"
    "../latex/mteh_HSK6_answers.pdf"
    "../latex/mteh_HSK6+_answers.pdf"
    "../latex/mteh_HSK6_noanswers.pdf"
    "../latex/mteh_HSK6+_noanswers.pdf"
    "../latex/mteh_HSK7-9_noanswers.pdf"
    "../latex/mteh_HSK7-9+_noanswers.pdf"
    "../latex/mteh_HSK7-9_answers.pdf"
    "../latex/mteh_HSK7-9+_answers.pdf"
    "../latex/mteh_nonHSK_answers.pdf"
    "../latex/mteh_nonHSK_noanswers.pdf"
)
