% this needs to be changed manually (for this test latex)
\providecommand{\version}{0.1.2}


% this version is used for small-scale testing so I don't have to generate 8+ different versions each time (like mteh_bulk.tex which is called from bash)
