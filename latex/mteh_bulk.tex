% 8 different versions are created: HSK5, HSK6, HSK7-9, all; and "answers" and "no answers".

% Default: hide answers
\newif\ifshowanswers
\showanswersfalse

% Turn on answers if bash defines \answerson
\ifdefined\answerson
  \showanswerstrue
\fi
...
\fancyfoot[L]{MteH~--~\hsklevel~--~v\version~--~CC BY-SA 4.0~--~\href{https://github.com/becky82/mteh}{GitHub: becky82/mteh}}
\fancyfoot[R]{\thepage}
...
\input{\datafile}  % expected to be provided by a bash call
