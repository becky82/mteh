...
| 8 | 氧 | yǎng | Oxygen | ![氧](./periodic_table/氧.jpg) | 有氧运动 (aerobics); 二氧化碳 (carbon dioxide); 好氧生物 (aerobic organism); 厌氧生物 (anaerobic organism) | [Wikimedia](https://commons.wikimedia.org/wiki/File:Underwater_photograph_of_a_recreational_scuba_diver_in_Playa_del_Carmen_2006.jpg) |
| 9 | 氟 | fú | Fluorine | ![氟](./periodic_table/氟.png) | 含氟牙膏 (fluoridated toothpaste); 氯氟烃 (CFCs); 铁氟龙 / 聚四氟乙烯 (Teflon); 氟利昂 (Freon) | [Amazon.com](https://www.amazon.com/Sensodyne-Toothpaste-Sensitivity-Protection-Refreshing/dp/B0BM4H31S1) |
...
| 11 | 钠 | nà | Sodium | ![钠](./periodic_table/钠.jpg) | 低钠食品 (low sodium foods); 氯化钠 (sodium chloride, or table salt) | [Wikimedia](https://commons.wikimedia.org/wiki/File:Salt_shaker_on_white_background.jpg) |
...
| 14 | 硅 | guī | Silicon | ![硅](./periodic_table/硅.jpg) | 硅谷 (Silicon Valley); 硅芯片 (silicon chip); 硅胶 (silicone); called 矽 (xī) in Taiwan | [Wikimedia](https://commons.wikimedia.org/wiki/File:VT82C686B.jpg) |
| 17 | 氯 | lǜ | Chlorine | ![氯](./periodic_table/氯.jpg) | 氯氟烃 (CFCs); 聚氯乙烯 (PVC); 氯化钠 (sodium chloride, or table salt) | [Wiktionary](https://commons.wikimedia.org/wiki/File:HK_STT_%E7%9F%B3%E5%A1%98%E5%92%80_Shek_Tong_Tsui_%E5%B1%B1%E9%81%93_9_Hill_Road_%E7%A5%A5%E7%99%BC%E5%A4%A7%E5%BB%88_Cheung_Fat_Building_shop_%E7%99%BE%E4%BD%B3%E8%B6%85%E5%B8%82_ParknShop_Supermarket_goods_%E9%AB%98%E6%A8%82%E6%B0%8F_Clorox_Bleach_August_2022_Px3.jpg) |
| 18 | 氩 | yà | Argon | ![氩](./periodic_table/氩.jpg) | 氩弧焊 (argon arc welding); 氩气保护 (argon gas shielding); inside some 灯泡 (light bulbs) such as 白炽灯 (incandescent lights) | [Wikimedia](https://commons.wikimedia.org/wiki/File:Shielded_Metal_Arc_Welding.jpg) |
| 19 | 钾 | jiǎ | Potassium | ![钾](./periodic_table/钾.jpg) | 钾肥 (potassium fertilizer) | [Wikimedia](https://commons.wikimedia.org/wiki/File:Potassium_glovebox.jpg) |
| 20 | 钙 | gài | Calcium | ![钙](./periodic_table/钙.jpg) | 补钙 (calcium supplement); 碳酸钙 (calcium carbonate) | [Pexels](https://www.pexels.com/photo/back-view-of-a-person-writing-on-a-blackboard-8197529/) |
...
| 29 | 铜 | tóng | Copper | ![铜](./periodic_table/铜.jpg) | 铜线 (copper wires); 铜牌 (bronze medal); 青铜 (bronze); the 自由女神 (Statue of Liberty) is made from 铜 | [Wikimedia](https://commons.wikimedia.org/wiki/File:Bronze_Monster_Mask_from_a_horse_bridle_Western_Zhou_dynasty_China_9th_century_BCE.jpg) |
...
| 烷 | wán | alkane | ![辛烷](./periodic_table/辛烷.png) | 甲烷 (methane, aka 沼气), 乙烷 (ethane), 丙烷 (bǐngwán), 丁烷 (butane), 戊烷 (pentane), 己烷 (hexane), 庚烷 (heptane), 辛烷 (octane), etc.; also called 烷烃 (wántīng) | [Wikimedia](https://commons.wikimedia.org/wiki/File:Octane-3D-balls.png) |
| 硝 | xiāo | niter | ![硝酸银](./periodic_table/硝酸银.png) | the character 硝 is used in 硝酸根 (nitrate, NO₃⁻) which forms ionic compounds such as 硝酸银 (silver nitrate, AgNO₃, pictured) and 硝酸钾 (potassium nitrate, KNO₃), and in 亚硝酸根 (nitrite, NO₂⁻) which forms ionic compounds such as 亚硝酸钠 (sodium nitrite, NaNO₂); the character 硝 is used in 硝石 (saltpeter, a natural source of 硝酸钾) used in gunpowder, and is also used figuratively 硝烟滚滚 to represent a raging battle | [Wikimedia](https://commons.wikimedia.org/wiki/File:Silver-nitrate-3D-vdW.png) |
| 羟 | qiǎng | hydroxyl | ![羟化氯喹](./periodic_table/羟化氯喹.png) | −OH, used in e.g. 羟化氯喹 (hydroxychloroquine, pictured) | [Wikimedia](https://commons.wikimedia.org/wiki/File:Hydroxychloroquine.png) |
