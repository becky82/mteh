...
| 硝 | xiāo | niter | ![硝酸银](./periodic_table/硝酸银.png) | the character 硝 is used in 硝酸盐 (nitrates, NO₃⁻) which form ionic compounds such as 硝酸银 (silver nitrate, AgNO₃, pictured) and 硝酸钾 (potassium nitrate, KNO₃, aka saltpeter used in gunpowder), and in 亚硝酸盐 (nitrites, NO₂⁻) which form ionic compounds such as 亚硝酸钠 (sodium nitrite, NaNO₂); it's also used figuratively 硝烟滚滚 to represent a raging battle | [Wikimedia](https://commons.wikimedia.org/wiki/File:Silver-nitrate-3D-vdW.png) |
