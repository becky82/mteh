...
- In [化学](化学.md) (chemistry), there are quite a few rare Chinese characters, such as each element on the periodic table.

- Each Chinese province, etc., is assigned a [省份简称](省份简称.md) (province abbreviation).

- There are [重叠字](重叠字.md), are composed of repeated components, which are often used decoratively.
...
- Characters relating to [哺乳动物](./哺乳动物.md) (mammals), [花卉](./花卉.md) (plants and flowers) [pre-first draft], [乐器](./乐器.md) (musical instruments).  

- Characters [历史人名](./历史人名.md) (historical names), [人名](./人名.md) (given names), [姓氏](./姓氏.md) (family names) [pre-first draft], [民族](./民族.md) (ethnic groups) [pre-first draft].

- There are some rare characters that you might see [in the wild](可遇字.md) in China.
...
You may also see things like 火炎焱燚 e.g. in online usernames.  See [Repeated-component characters](重叠字.md) for a fairly comprehensive list of characters which are composed of repeated components like this; they're often used decoratively.
